...
var controlledPropUpdater = {
  path: function path(obj, arg) {
    obj.setPath(arg.map(function (point) {
...
function (_React$Component) {
  ...
  _createClass(Polyline, [{
    ...
    value: function componentDidMount() {
      ...
      this.polyline = new BMap.Polyline(path.map(function (point) {
        return (0, _typeTransform.toBMapPoint)(point);
      })); // eslint-disable-line no-undef

      this.props[_constants.MAP].addOverlay(this.polyline);
    }
  }, {
    key: "render",
...
_defineProperty(Polyline, "propTypes", _defineProperty({}, _constants.MAP, _propTypes["default"].object));

var _default = (0, _wrapClass["default"])(Polyline, controlledPropTypes, controlledPropUpdater, publicMethodMap, eventMap);
