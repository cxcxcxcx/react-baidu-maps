...
function (_React$Component) {
  ...
  _createClass(Polygon, [{
    ...
    value: function componentDidMount() {
      ...
      this.polygon = new BMap.Polygon(path.map(function (point) {
        return (0, _typeTransform.toBMapPoint)(point);
      })); // eslint-disable-line no-undef

      this.props[_constants.MAP].addOverlay(this.polygon);
    }
  }, {
    key: "render",
...
_defineProperty(Polygon, "propTypes", _defineProperty({}, _constants.MAP, _propTypes["default"].object));

var _default = (0, _wrapClass["default"])(Polygon, controlledPropTypes, controlledPropUpdater, publicMethodMap, eventMap);
