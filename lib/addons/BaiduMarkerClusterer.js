...
var _TextIconOverlay = _interopRequireDefault(require("./TextIconOverlay"));
...
(function () {
  ...
  function Cluster(markerClusterer) {
    ...
    this._clusterMarker = new _TextIconOverlay["default"](this._center, this._markers.length, {
  ...
  Cluster.prototype.updateClusterMarker = function () {
    ...
    var thatBounds = this.getBounds(); //this._clusterMarker.addEventListener("click", function(event){
